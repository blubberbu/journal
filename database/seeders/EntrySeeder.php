...
class EntrySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $bodies = ['Photograph by: Jezael Melgoza (https://unsplash.com/photos/alY6_OpdwRQ)', 'Photograph by: Manson Yim (https://unsplash.com/photos/lYDOrOkR_GU)', 'Photograph by: Darian Jason', 'Photograph by: Etienne Bösiger (https://unsplash.com/photos/WTkUYzNCu-A)', 'Photograph by: Darian Jason, 100% unedited'];
